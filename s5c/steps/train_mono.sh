...
if [ $stage -le 0 ]; then
  gmm-est --min-gaussian-occupancy=1 --min-count=1 --mix-up=$numgauss --power=$power \
...
# --min-count=1 --min-gaussian-occupancy=1

    $cmd $dir/log/update.$x.log \
      gmm-est --write-occs=$dir/$[$x+1].occs --min-count=1 --min-gaussian-occupancy=1 \
