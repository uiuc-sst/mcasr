...
# #Uyghur
# dictp_graph=/ws/ifp-53_1/hasegawa/lsari2/data/mcasr/fromWenda/dict_prob.txt
...
utils/int2sym.pl -f 3- $odir/phonemap.txt $odir/lexiconp.intt > $odir/lexiconp.txt
