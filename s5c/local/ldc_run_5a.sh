...
if [ "$#" -lt 4 ]; then
  echo "Usage: $0 <data-dir> <lang-dir> <in-exp-dir> <out-exp-dir>"
  echo "e.g.: $0 data/Uzbek data/Uzbek/lang exp/Uzbek/tri4b_ali exp/Uzbek/tri5a_nnet"
  exit 1
fi
...
if [ ! -f $dir/final.mdl ]; then
  ...
  steps/nnet2/train_pnorm_fast.sh --stage $train_stage \
   ...
   --cmd "$decode_cmd" \
    $datadir $langdir $alidir $dir || exit 1
fi
